...
public class HPinBlazeGraphDBTest{
	public Graph graph;
	long start;
	StringBuffer sb;
	...
	public  HPinBlazeGraphDBTest() throws InterruptedException {
		graph = (Graph)   BlazeGraphFactory.open("blazegraph1.jnl");
	}
	...
	public void save()
	{
		...
		GraphMLWriter.outputGraph(graph, new OutputStream(""));
	}
