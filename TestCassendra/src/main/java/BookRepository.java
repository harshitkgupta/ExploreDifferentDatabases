...
public class BookRepository {
    ...
    public void insertbooks(List<Book> books) {
        ...
        for(int i=0;i<books.size();i++){
        	...
        	sb.append("INSERT INTO ").append(TABLE_NAME).append("(id, title, author, subject) ").append("VALUES (").append(book.getId()).append(", '").append(book.getTitle()).append("', '").append(book.getAuthor()).append("', '")
                .append(book.getSubject()).append("');");
        }
